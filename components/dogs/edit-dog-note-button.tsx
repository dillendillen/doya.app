...
type EditDogNoteButtonProps = {
  noteId: string;
  initialBody: string;
};

export function EditDogNoteButton({ noteId, initialBody }: EditDogNoteButtonProps) {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(`/api/dogs/notes/${noteId}`, {
        method: "PATCH",
        headers: {
